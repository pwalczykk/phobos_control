...
struct Status{
    ...
    void VelLink0(int32_t link_0){    this->link_0 = link_0;}
    void VelLink1(int32_t link_1){    this->link_1 = link_1;}
    void VelLink2(int32_t link_2){    this->link_2 = link_2;}
    void VelLink3(int32_t link_3){    this->link_3 = link_3;}
    void VelLink4(int32_t link_4){    this->link_4 = link_4;}

    void VelGripper(int32_t gripper){   this->gripper = gripper;}

    void VelWheels(int32_t linear_vel, int32_t angular_vel){
        this->wheels_left = linear_vel + angular_vel;
        this->wheels_right = linear_vel - angular_vel;
    }

    void KeyDownCallback(int32_t key)
    {
        switch(key)
        {
    ...
    void KeyUpCallback(int32_t key)
    {
        switch(key)
        {
