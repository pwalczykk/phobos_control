...
int32_t link4_vel = 1;
int32_t grip_vel = 1;
int32_t tower_yaw_vel = 1;
int32_t tower_pitch_vel = 1;

int32_t rover_linear_1 = 4;
int32_t rover_linear_2 = 3;
int32_t rover_angular_1 = 6;
int32_t rover_angular_2 = 4;

int main(int argc, char** argv)
{
    ros::init(argc, argv, "keyboard_teleop_old");
    ros::NodeHandle nh;
